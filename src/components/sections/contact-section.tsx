...
import { generateToken, validateEmail, validateText } from "@/lib/security";
...
export function ContactSection({ onSubmit, isAdmin }: ContactSectionProps) {
  ...
  function validate(): boolean {
    ...
    const nameCheck = validateText(form.name, {
      required: true,
      minLen: 2,
      maxLen: 80,
      rejectCRLF: true,
    ...
    const subjectCheck = validateText(form.subject, {
      required: true,
      minLen: 3,
      maxLen: 120,
      rejectCRLF: true,
    ...
    const messageCheck = validateText(form.message, {
      required: true,
      minLen: 10,
      maxLen: 2000,
    });
        ...
        {isAdmin ? (
          <Card className="border-2 border-amber-500/40 bg-amber-50/50 shadow-md dark:border-amber-500/30 dark:bg-amber-950/20">
            <CardContent className="flex flex-col items-start gap-4 p-8">
              <span className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-amber-500/15 text-amber-600 dark:text-amber-400">
                <ShieldAlert className="h-6 w-6" aria-hidden="true" />
              </span>
              <div className="space-y-1.5">
                <h3 className="font-display text-lg font-bold text-foreground">
                  Sign out to send a message
                </h3>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  You&apos;re signed in as an admin. The contact form is a
                  public intake channel for members and partners, not a
                  self-message path. Log out, then return here to submit your
                  message.
                </p>
              </div>
              <Alert className="border-amber-500/30 bg-amber-500/5 text-amber-900 dark:text-amber-200">
                ...
                <AlertDescription className="text-xs">
                  Admin sessions are blocked from submitting on both the client
                  and the server. This keeps the public inbox free of test or
                  self-sent messages.
                </AlertDescription>
              </Alert>
            </CardContent>
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p className="max-w-[200px] text-xs">
                              Select the category that best fits your message.
                            </p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="max-w-[220px] text-xs">
                            Minimum 10 characters. Be clear and concise.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
